...
const About = ({ classes }) => (
  <Page selected="about">
    <Paper className={classes.root}>
      ...
      PreserVenice is a non-profit organization devoted to the preservation and restoration of public art in Venice, Italy.
      Please help us preserve this inestimable collection by using our App to collect up-to-date information about the artifacts and to donate funds for their restoration.
      </Typography>
