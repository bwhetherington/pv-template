      ...
      <React.Fragment>
        ...
        <Page selected="home">
          ...
          <Typography paragraph>
            ...
            public art in Venice, Italy. Please help us preserve this inestimable collection by
            using our App to collect up-to-date information about the artifacts and to donate funds
            ...
            {priorityArtifactsSample.map(artifact => (
              <Grid item key={artifact.name} xs={4}>
                <ArtifactCard
                  ...
                  onClick={this.onArtifactClick(artifact)}
                />
              </Grid>
            ))}
          </Grid>
